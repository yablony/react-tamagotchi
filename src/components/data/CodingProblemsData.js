const problems = {
    'easy': [
        ...
        "Write a function that takes an array as input and returns an array with the elements in a reversed order. Use array methods to solve this problem.\nCall the function on: [1, 2, 3, 4, 5]. It should output: [5, 4, 3, 2, 1]",
...
const solutions = {
    ...
    'medium': [
        ...
        `const capitalizeFirstLetters = sentence => sentence.split(' ').map(word => word.charAt(0).toUpperCase() + word.slice(1)).join(' ');
        capitalizeFirstLetters("I hope I'm your favourite pet. Don't tell your cat!");`
    ],
    'hard': [
